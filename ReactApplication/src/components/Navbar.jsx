            ...
            <ul className="navbar-nav">
              <li className="nav-item mx-3">
                <Link
                  ...
                  style={{ fontFamily: "New Times Roman, sans-serif" }}
                >
              ...
              <li className="nav-item mx-3">
                <Link
                  ...
                  style={{ fontFamily: "New Times Roman, sans-serif" }}
                >
                  <span className="navbar-text text-white fw-bold">Teams</span>
                </Link>
              </li>
              <li className="nav-item mx-3">
                <Link
                  ...
                  style={{ fontFamily: "New Times Roman, sans-serif" }}
                >
                  <span className="navbar-text text-white fw-bold">Races</span>
                </Link>
              </li>
            </ul>
          </div>
